...
export const standupReminderMapping = {
  [standupQuestion1.name]: reminderQuestion1.name,
  [standupQuestion2.name]: reminderQuestion2.name,
  [standupQuestion3.name]: reminderQuestion3.name,
  [standupQuestionOptional1.name]: reminderQuestionOptional1.name,
}
