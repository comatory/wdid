 ...
 * @property {string} standupCron
 * @property {string} remindCron
 */
...
/**
 * @typedef {Object} CronConfiguration
 * @property {string} standupCron
 * @property {string} remindCron
 *
 * load cron configuration
 * @returns {CronConfiguration} cron settings
 */
export const readCronConfiguration = async () => {
  const configuration = await readConfigurationFile()
  const { standupCron, remindCron } = configuration
