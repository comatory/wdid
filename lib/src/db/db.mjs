 ...
 * @property {() => Promise<?Array<Entry>>} getStandupAnswers - get stand-up answers
 * @property {() => Promise<?Array<Entry>>} getStandupReminders - get stand-up reminders
 ...
 */
const getStandupAnswers = async () => {
  return getTodayAnswersByType(ENTRY_TYPES.STANDUP)
}
